...
public class WarmDrink extends CoffeeShop implements ManageItemInEveryCategory {
    public static void loadItemAsWarmDrink() throws IOException {
        FileInputStream inputStream = new FileInputStream("warm_drink.txt");
        ...
        while ((line = br.readLine()) != null) {
            ...
            listOfWarmDrink.add(item);
        }
        inputStream.close();
    }

    public void viewItems() {
        System.out.println("List of warm_drink:");
        for (Item eachItem : listOfWarmDrink) {
    ...
    public void addItemByAdmin(String itemName, int price) {
        ...
        if (newItem != null)
            ...
            try (PrintWriter output = new PrintWriter(new FileWriter("warm_drink.txt", true))) {
                output.printf("%s\r\n", itemName + " " + price + " " + "AVAILABLE");
                listOfWarmDrink.add(newItem);
    ...
    public void removeItemByAdmin(String itemName) throws IOException {
        ...
        if (deletedItem == null)
            ...
            ManageItemInEveryCategory.deleteLine("warm_drink.txt", deletedLine);
            listOfWarmDrink.remove(deletedItem);
